...
{ 
    public class AlphabetWithSpaceValidationAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            var customMethodAttribute = new CustomValidationAttribute(typeof(AlphabetWithSpaceValidationAttribute), "ValidateInputToAcceptOnlyAlphabets");
